from src.topic_agent.agents.knowledge_router import route_query
from src.topic_agent.agents.query_understanding import understand_query
from src.topic_agent.agents.research_planner import create_research_plan
from src.topic_agent.models import PlanningResult
...
def run_planning_workflow(query: str) -> PlanningResult:
    ...
    if plan == "build_new_grpah" or plan == "update_exisitng_graph":
